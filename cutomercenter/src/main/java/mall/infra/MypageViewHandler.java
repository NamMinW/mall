...
public class MypageViewHandler {
    ...
    public void whenDeliveryCompleted_then_UPDATE_1(
        ...
        try {
            ...
            for (Mypage mypage : mypageList) {
                ...
                mypage.setStatus(String.valueOf(deliveryCompleted.getStatus()));
                mypage.setAddress(
                    String.valueOf(deliveryCompleted.getAddress())
                );
                // view 레파지 토리에 save
                mypageRepository.save(mypage);
            }
    ...
    public void whenDeliveryCanceled_then_UPDATE_2(
        ...
        try {
            ...
            for (Mypage mypage : mypageList) {
                // view 객체에 이벤트의 eventDirectValue 를 set 함
                mypage.setStatus(String.valueOf(deliveryCanceled.getStatus()));
                // view 레파지 토리에 save
                mypageRepository.save(mypage);
            }
        } catch (Exception e) {
